...
/* =========================================================
   STORY / QUEST CONTENT
   Everything the King and the shopkeepers say. Edit freely —
   the quest logic in js/ui.js just reads these strings.
========================================================= */
const KING_NAME = "King Nalinor";

const QUEST_TEXT = {
  introTitle: "The King's Welcome",
  intro: `Rise, traveler! I am ${KING_NAME}, keeper of this small kingdom raised by ${PROFILE.name}. Beyond my gates stand six shops, and each one guards a piece of my kingdom's story — my Café, my Workshop, my Arcade, my Hall, my Library and my Post Office. Ride out, visit all six, and return to me — a treasure awaits the one who sees the whole kingdom.`,
  progressTitle: "The King's Quest",
  rewardTitle: "A King's Reward",
  reward: `You have seen every corner of my kingdom — well ridden! As promised, here is my treasure: the key to ${PROFILE.name}'s full portfolio and every way to reach ${PROFILE.name.split(" ")[0]} directly. May it serve you well, traveler.`,
  rewardAlreadyGiven: `Welcome back, traveler. My treasure is yours already — but you're always welcome to ride my kingdom again.`,
  notDoneYet: (remaining)=> remaining.length === 1
    ? `Only one shop left unvisited: ${remaining[0]}. Seek it out, and return to me!`
    : `You still have ${remaining.length} shops left to visit: ${remaining.join(", ")}.`
};

const SHOPKEEPER_LINES = {
  about:        "The King sent you? Step inside the Café to learn who I work for.",
  skills:       "Every good kingdom needs sharp tools — see mine in the Workshop!",
  projects:     "Step into the Arcade — a few of my favourite builds live in there.",
  certificates: "Proof of every course I've finished hangs in the Hall. Have a look!",
  education:    "My whole academic journey is shelved in the Library, come in and read.",
  contact:      "Ready to reach out? The Post Office has every way to find me."
};
